...
ENV PYTHONPATH=${PYTHONPATH}:/opt/intel/openvino/python/python3.6/ubuntu18

# Append library path
ENV LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/opt/intel/openvino/deployment_tools/inference_engine/lib/ubuntu_18.04/intel64
